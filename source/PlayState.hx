...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['EMOTIONAL DAMAGE', 0.4], //From 20% to 39%
		['Yikes', 0.5], //From 40% to 49%
		['Well..', 0.6], //From 50% to 59%
		['Meh..', 0.69], //From 60% to 68%
		['Okay', 0.7], //69%
		['Nice', 0.8], //From 70% to 79%
		['Awesome', 0.9], //From 80% to 89%
		['Beautiful', 1], //From 90% to 99%
		['SO WUNDERBAR!!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "YOU SUCK!", 32);
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.BLACK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.RED);
